...
//
//  Info
///  WGR_SEL: Lesen von Warengruppen und Rückgabe der angegeben Felder
//
...
begin
  ...
  vArgs # VarAllocate(Sel_Args_000039);
...
*/
  ...
  // --------------------------------------------------------------------------
  // Daten selektieren
  vSel  # Lib_SOA:CreatePartSel(c_DATEI, 1, 'SVC_000039:Sel',vArgs);
...
begin
  ...
  VarInstance(Sel_Args_000039, SOA_PartSel_Args);
