...
//===== Business-Control =================================================
//
//  Prozedur  L_STD_Art1001
//                    OHNE E_R_G
//  Info
//
//
//  01.06.2021 SR SQL-Umänderung (Kopie von L_STD_Adr0001)
//
//  Subprozeduren
//
//========================================================================
...
begin
  ...
  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.STD.Art1001',here+':AusSel');
...
begin
  ...
  AddJSONBool(vJSON, 'MitBagOutputs', false);
