...
//===== Business-Control =================================================
//
//  Prozedur  L_STD_Erl0012   IntrastarExport
//                    OHNE E_R_G
//  Info
//
...
begin
  ...
  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.STD.Erl0012',here+':AusSel');
...
begin
  ...
  AddJsonBool(  vJSON,  'AuftragsIntra',        ausAuftrag);
