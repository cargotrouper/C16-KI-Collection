...
//  11.04.2013  AI  DB1 wird mit Kosten ausgegeben und ist damit DB2
//  27.11.2020  TM  XML-Ausgabe mit kpl. Kundenadresse zu Prj. 2100/25
//  13.06.2022  AH  ERX
//
//  Subprozeduren
//    MAIN
...
begin
  ...
  gMDI # Lib_GuiCom:AddChildWindow(gMDI, 'Sel.LST.450014', here + ':AusSel');
...
begin
  ...
  case aName of
    ...
    'Pos' : begin
      ...
      Write(6,  ZahlF(s_DBLJ,1)                           ,y , _LF_Num);
      Write(7,  ZahlF(vSpanLJ,1)                          ,y , _LF_Num);

      Write(8,  ZahlF(s_GewVJ,1)                          ,y , _LF_Num);
      Write(9,  ZahlF(s_UmsVJ,1)                          ,y , _LF_Wae);
      Write(10, ZahlF(vProzVJ,1)                          ,y , _LF_Num);
      Write(11, ZahlF(vDurchVJ,2)                         ,y , _LF_Wae);
      Write(12, ZahlF(s_DBVJ,1)                           ,y , _LF_Num);
      Write(13, ZahlF(vSpanVJ,1)                          ,y , _LF_Num);

      Write(14, ZahlF(vGew,1)                             ,y , _LF_Num);
      Write(15, ZahlF(vUms,1)                             ,y , _LF_Wae);
      Write(16, ZahlF(vProz,1)                            ,y , _LF_Num);
      Write(17, ZahlF(vDurch,2)                           ,y , _LF_Wae);
      Write(18, ZahlF(vDB,1)                              ,y , _LF_Num);
      Write(19, ZahlF(vSpan,1)                            ,y , _LF_Num);
      
      
      // NEU: Prj. 2100/25
      if (List_XML) then begin
        
        Write(20, Adr.Name    ,n , 0);
        Write(21, Adr.Zusatz  ,n , 0);
        Write(22, "Adr.Straße",n , 0);
        Write(23, Adr.PLZ     ,n , 0);
        Write(24, Adr.Ort     ,n , 0);
        Write(25, Adr.LKZ ,n , 0);
        Erx # RecLink(110,100,16,_RecFirst)
        if (Erx = _rOk) then
          Write(26, Ver.Stichwort, n, 0);
      end;
    ...
    'ZwischenSumme' : begin
      ...
      Write(2,  ZahlF(gZSGewLJ   , 1)                           , y, _LF_Num);
      Write(3,  ZahlF(gZSUmsLJ   , 1)                           , y, _LF_Wae);
      Write(4,  ZahlF(gZSProzLJ  , 1)                           , y, _LF_Num);
      Write(5 , ZahlF(gZSDurchLJ , 2)                           , y, _LF_Wae);
      Write(6,  ZahlF(gZSDBLJ    , 1)                           , y, _LF_Num);
      Write(7,  ZahlF(gZSSpanLJ  , 1)                           , y, _LF_Num);

      Write(8,  ZahlF(gZSGewVJ   , 1)                           , y, _LF_Num);
      Write(9,  ZahlF(gZSUmsVJ   , 1)                           , y, _LF_Wae);
      Write(10, ZahlF(gZSProzVJ  , 1)                           , y, _LF_Num);
      Write(11, ZahlF(gZSDurchVJ , 2)                           , y, _LF_Wae);
      Write(12, ZahlF(gZSDBVJ    , 1)                           , y, _LF_Num);
      Write(13, ZahlF(gZSSpanVJ  , 1)                           , y, _LF_Num);

      Write(14, ZahlF(gZSGew     , 1)                           , y, _LF_Num);
      Write(15, ZahlF(gZSUms     , 1)                           , y, _LF_Wae);
      Write(16, ZahlF(gZSProz    , 1)                           , y, _LF_Num);
      Write(17, ZahlF(gZSDurc    , 2)                           , y, _LF_Wae);
      Write(18, ZahlF(gZSDB      , 1)                           , y, _LF_Num);
      Write(19, ZahlF(gZSSpan    , 1)                           , y, _LF_Num);
      EndLine();
     end; // GesamtSumme
    ...
    'Rest' : begin
      ...
      Write(4,  ZahlF(vProzLJ,1)                          ,y , _LF_Num);
      Write(5 , ZahlF(vDurchLJ,2)                         ,y , _LF_Wae);
      Write(6,  ZahlF(gRDBLJ,1)                            ,y , _LF_Num);
      Write(7,  ZahlF(vSpanLJ,1)                          ,y , _LF_Num);

      Write(8,  ZahlF(gRGewVJ,1)                           ,y , _LF_Num);
      Write(9,  ZahlF(gRUmsVJ,1)                           ,y , _LF_Wae);
      Write(10, ZahlF(vProzVJ,1)                          ,y , _LF_Num);
      Write(11, ZahlF(vDurchVJ,2)                         ,y , _LF_Wae);
      Write(12, ZahlF(gRDBVJ,1)                            ,y , _LF_Num);
      Write(13, ZahlF(vSpanVJ,1)                          ,y , _LF_Num);
    ...
    'GesamtSumme' : begin
      ...
      Write(4,  ZahlF(vProzLJ,1)                          ,y , _LF_Num);
      Write(5 , ZahlF(vDurchLJ,2)                         ,y , _LF_Wae);
      Write(6,  ZahlF(gDBLJ,1)                            ,y , _LF_Num);
      Write(7,  ZahlF(vSpanLJ,1)                          ,y , _LF_Num);

      Write(8,  ZahlF(gGewVJ,1)                           ,y , _LF_Num);
      Write(9,  ZahlF(gUmsVJ,1)                           ,y , _LF_Wae);
      Write(10, ZahlF(vProzVJ,1)                          ,y , _LF_Num);
      Write(11, ZahlF(vDurchVJ,2)                         ,y , _LF_Wae);
      Write(12, ZahlF(gDBVJ,1)                            ,y , _LF_Num);
      Write(13, ZahlF(vSpanVJ,1)                          ,y , _LF_Num);
...
begin
  ...
  if (aSeite=1) then begin
    ...
    if (Sel.Adr.von.Vertret <> 0) then begin
      StartLine();
      //Write(1, 'Vertreter: ' + ZahlI(Sel.Adr.von.Vertret), n, 0);
      
      Ver.Nummer # Sel.Adr.von.Vertret;
      Erx # RecRead(110, 1, 0);
      if (Erx = _rOk) then
        Write(1, 'Vertreter: ' + Ver.Stichwort, n, 0);
      EndLine();
    end;
    
    if (Sel.Adr.von.Verband <> 0) then begin
      StartLine();
      //Write(1, 'Verband: ' + ZahlI(Sel.Adr.von.Verband), n, 0);
      
      Ver.Nummer # Sel.Adr.von.Verband;
      Erx # RecRead(110, 1, 0);
      if (Erx = _rOk) then
        Write(1, 'Verband: ' + Ver.Stichwort, n, 0);
      EndLine();
    end;
    
    if (Sel.Adr.von.LKZ <> '') then begin
      StartLine();
      Write(1, 'LKZ: ' + Sel.Adr.von.LKZ, n, 0);
      EndLine();
    end;
  ...
  List_Spacing[23]  # List_Spacing[22] + 20.0;
  List_Spacing[24]  # List_Spacing[23] + 20.0;
  List_Spacing[25]  # List_Spacing[24] + 20.0;
  List_Spacing[26]  # List_Spacing[25] + 20.0;
  ...
  Write(2,  'Z1 Absatz t '                          ,y , 0);
  Write(3,  'Z1 Umsatz '+"Set.Hauswährung.Kurz"     ,y , 0);
  Write(4,  'Z1 Umsatz % '                          ,y , 0);
  Write(5,  'Z1 Ø '+"Set.Hauswährung.Kurz"+' / t'   ,y , 0);
  Write(6,  'Z1 Deckungsb. '+"Set.Hauswährung.Kurz" ,y , 0);
  Write(7,  'Z1 Spanne %'                           ,y , 0);

  Write(8,  'Z2 Absatz t'                           ,y , 0);
  Write(9,  'Z2 Umsatz '+"Set.Hauswährung.Kurz"     ,y , 0);
  Write(10, 'Z2 Umsatz % '                          ,y , 0);
  Write(11, 'Z2 Ø '+"Set.Hauswährung.Kurz"+' / t'   ,y , 0);
  Write(12, 'Z2 Deckungsb. '+"Set.Hauswährung.Kurz" ,y , 0);
  Write(13, 'Z2 Spanne %'                           ,y , 0);

  Write(14, 'Absatz Diff t'                                       ,y , 0);
  Write(15, 'Umsatz Diff '+"Set.Hauswährung.Kurz"                 ,y , 0);
  Write(16, 'Umsatz Diff %'                                       ,y , 0);
  Write(17, 'Diff Ø '+"Set.Hauswährung.Kurz"+' / t'               ,y , 0);
  Write(18, 'Deckungsb. Diff '+"Set.Hauswährung.Kurz"             ,y , 0);
  Write(19, 'Spanne Diff %'                                       ,y , 0);

// NEU: Prj. 2100/25
      if (List_XML) then begin
        
        Write(20,'Kundenname' ,n , 0);
        Write(21, 'Zusatz'    ,n , 0);
        Write(22, 'Straße'    ,n , 0);
        Write(23, 'PLZ'       ,n , 0);
        Write(24, 'Ort'       ,n , 0);
        Write(25, 'Land'      ,n , 0);
        Write(26, 'Verband'   ,n , 0);
      end;
...
begin
  ...
  if(Sel.Adr.von.Verband <> 0) then
    Lib_Sel:QInt(var vQ100, 'Adr.Verband', '=', Sel.Adr.von.Verband);
  ...
  WHILE (Erx <= _rLocked) DO BEGIN // Material loopen
    ...
    WHILE(Erx <= _rLocked) DO BEGIN
      ...
      // 11.04.2013:
      vX # vX + Erl.K.InterneKostW1;      // interne Kosten dazuaddieren
...
//debug('re:'+erl.kundenstichwort+cnvai(erl.rechnungsnr)+'  '+cnvad(Erl.rechnungsdatum));
  ...
  WHILE (vItem != 0) do begin
    ...
    Erx # RekLink(100,450,5,0);   // Kunde holen
    if Erx > _rlocked then recbufclear(100);
    Erx # RekLink(812,100,10,0);  // Land holen
