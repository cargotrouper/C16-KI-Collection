...
//===== Business-Control =================================================
//
//  Prozedur  L_STD_Ein1002
//                    OHNE E_R_G
//  Info
//    Gibt eine Wareneingangsliste aus
//
//  29.06.2021 SR SQL-Umänderung (Kopie von L_STD_Ein0002)
//
//  Subprozeduren
//
//========================================================================
...
begin
  ...
  "Sel.Fin.GelöschteYN"   # y;  // mit ERE
  "Sel.Fin.!GelöschteYN"  # y;  // ohne ERE
  ...
  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.STD.Ein1002',here+':AusSel');
...
begin
  ...
  // ----------------------------------------------------------
  AddJsonBool( vJSON,   'MitEingaengen',    "Sel.Auf.RahmenYN");
  AddJsonBool( vJSON,   'MitVSBEintraegen', "Sel.Auf.AbrufYN");
  AddJsonBool( vJSON,   'MitAusfaellen',    "Sel.Auf.NormalYN");
  ...
  AddJsonBool( vJSON,   'MitERe',           "Sel.Fin.GelöschteYN");
  AddJsonBool( vJSON,   'MitOhneERe',       "Sel.Fin.!GelöschteYN");
