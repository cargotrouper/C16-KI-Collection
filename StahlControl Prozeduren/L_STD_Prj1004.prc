...
//===== Business-Control =================================================
//
//  Prozedur  L_STD_Prj1004
//                    OHNE E_R_G
//  Info
//
//
//  01.07.2021 SR SQL-Umänderung (Kopie von L_STD_Prj0004)
//
//  Subprozeduren
//
//========================================================================
...
begin
  ...
  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.STD.Prj1004',here+':AusSel');
...
begin
  ...
  AddJSONInt(vJSON, 'NurProjektnr', Sel.Prj.Projektnr);          // Fehlt noch in C#
  ...
  AddJSONInt(vJSON, 'VonPosStatus', Sel.Prj.Pos.Status);      // Fehlt noch in C#
  AddJSONInt(vJSON, 'BisPosStatus', Sel.Prj.Pos.BisStat);     // Fehlt noch in C#
  ...
  AddJSONBool(vJSON, 'MitOffenen', Sel.Mat.EigenYN);
  AddJSONBool(vJSON, 'MitGeloeschten', "Sel.Mat.!EigenYN");
   
   
  //AddJSONAlpha(vJSON, 'BackgroundPic', '');
