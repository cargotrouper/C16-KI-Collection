...
//===== Business-Control =================================================
//
//  Prozedur  L_STD_Auf0008
//                    OHNE E_R_G
//  Info
//    Gibt die Auftragsliste im Bezug auf den Zusagetermin aus
//
//  19.10.2021  SR  Erstellung der Prozedur
//
//  Subprozeduren
//
//========================================================================
...
begin
  ...
  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.STD.Auf0008',here+':AusSel');

  Sel_Main:AddSort(gMdi, 'Kunden-Stichwort',      'Kunde');
  Sel_Main:AddSort(gMdi, 'Zusagetermin',          'Zusagetermin', true);
...
// 07.03.2022 AH
  AddJsonBool(  vJSON,  'LadeBestellPositionen',    y);
