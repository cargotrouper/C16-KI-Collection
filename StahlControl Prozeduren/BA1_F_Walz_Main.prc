...
//==== Business-Control ==================================================
//
//  Prozedur    BA1_F_Walz_Main
//                  OHNE E_R_G
//  Info
//
//
//  02.12.2009  AI  Erstellung der Prozedur
//  08.06.2018  AH  Neu: AFX "BA1.F.Init.Pre"
//  29.11.2019  AH  Funktionen zentralisiert in BA1_F_Main
//  27.07.2021  AH  ERX
//  19.07.2022  HA  Quick Jump
//  2022-09-14  AH  Mengenberechnung rausgenommen
//
//  Subprozeduren
...
define begin
  cDialog :   $BA1.F.Walzen.Maske
  cTitle :    'Walzen Fertigung'
  cFile :     703
...
//  SetStdAusFeld('edBAG.F.Artikelnummer'   ,'Struktur');
  ...
  RunAFX('BA1.F.Init.Pre',aint(aEvt:Obj));
...
/* 2022-09-14 AH    "BAG.F.Stückzahl"       # BAG.IO.Plan.Out.Stk;
...
/***    2022-09-14  AH  : Walzenm wir nie Menge ändern
