  ...
  case (StrCnv(vFeld, _StrUpper)) of
    ...
    'TITEL'       : begin
                      if (Ein.Vorgangstyp=c_Anfrage) then
                        ...
                        vA # 'Purchase order ' + AInt("Ein.P.Nummer")+' aus Rahmenvertrag ' + AInt("Ein.P.AbrufAufNr")
                      else
                        vA # 'Purchase order' + ' ' + AInt(Ein.P.Nummer);
    ...
    'TITELZUSATZ' : begin
                      if ("Ein.GültigkeitVom"<>0.0.0) or ("Ein.GültigkeitBis"<>0.0.0) then begin
                        ...
                        if ("Ein.GültigkeitVom"<>0.0.0) then
                          vA3 # vA3 + ' from '+cnvad("Ein.GültigkeitVom");
                        if ("Ein.GültigkeitBis"<>0.0.0) then
                          vA3 # vA3 + ' until '+cnvad("Ein.GültigkeitBis");
                        vA3 # vA3 + ')';
                      end;
...
//                              StrAdj(aBuf101We->Adr.A.LKZ,_StrBegin | _StrEnd)    + '-' +
    ...
    'LIB.BEZEICHNUNG'  :  if (Lib.Bezeichnung.L2<>'') then begin
                            inc(vZeilen);
                            AddLIZ(var aLabels, var aInhalt, var aZusatz, vTitel, Lib.Bezeichnung.L2, vPre, vPost, aKombi);
                          end;
    'VSA.BEZEICHNUNG' :   if (VsA.Bezeichnung.L2<>'') then begin
                            inc(vZeilen);
                            AddLIZ(var aLabels, var aInhalt, var aZusatz, vTitel, VSa.Bezeichnung.L2, vPre, vPost, aKombi);
                          end;
...
begin
  ...
  case (StrCnv(vFeld, _StrUpper)) of
    ...
    'WGR' :         if (Wgr.Bezeichnung.L2<>'') then begin
                      inc(vZeilen);
                      AddLIZ(var aLabels, var aInhalt, var aZusatz, vTitel, "Wgr.Bezeichnung.L2", vPre, vPost, aKombi);
                    end;
    ...
    'MENGE+MEH' :   if ("Ein.P.Menge.Wunsch"<>0.0) then begin
                      ...
                      if (Ein.P.MEH.Wunsch='kg') then
                        ...
                        AddLIZ(var aLabels, var aInhalt, var aZusatz, vTitel, anum("Ein.P.Menge.Wunsch", 0)+' '+'pcs', vPre, vPost, aKombi)
                      else
    ...
    'MENGE2+MEH' :   if ("Ein.P.Menge"<>0.0) then begin
                      ...
                      if (Ein.P.MEH='kg') then
                        ...
                        AddLIZ(var aLabels, var aInhalt, var aZusatz, vTitel, anum("Ein.P.Menge", 0)+' '+'pcs', vPre, vPost, aKombi)
                      else
    ...
    'TERMIN' :      begin
                      ...
                      if (Ein.P.Termin1W.Art = 'DA') then begin
                        ...
                        vA # 'week ' + CnvAi(Ein.P.Termin1W.Zahl,_FmtNumLeadZero) + '/' +
                        ...
                        vA # CnvAi(Ein.P.Termin1W.Zahl,_FmtNumNoZero) + '. quarter ' +
                             CnvAi(Ein.P.Termin1W.Jahr,_FmtNumNoGroup);
                        end
                        ...
                        vA # 'year ' +  CnvAi(Ein.P.Termin1W.Jahr,_FmtNumNoGroup);
                      end;
                      AddLIZ(var aLabels, var aInhalt, var aZusatz, vTitel, vA, vPre, vPost, aKombi);
                    end;
    'ZUSAGETERMIN' :  if (Ein.P.TerminZusage<>0.0.0) then begin
                      ...
                      if (Ein.P.Termin1W.Art = 'DA') then begin
                        ...
                        vA # CnvAi(Ein.P.TerminZ.Zahl,_FmtNumNoZero) + '. quarter ' +
                             CnvAi(Ein.P.TerminZ.Jahr,_FmtNumNoGroup);
                        end
                      else if (Ein.P.Termin1W.Art = 'SE') then begin
                        ...
                        vA # 'year ' +  CnvAi(Ein.P.TerminZ.Jahr,_FmtNumNoGroup);
                      end;
                      AddLIZ(var aLabels, var aInhalt, var aZusatz, vTitel, vA, vPre, vPost, aKombi);
                    end;
...
//                    end;
    ...
    'MEH' :         begin
                      inc(vZeilen);
                      if (Ein.P.Meh.Preis != 'Stk') then AddLIZ(var aLabels, var aInhalt, var aZusatz, vTitel, Ein.P.Meh.Preis, vPre, vPost, aKombi)
                      else AddLIZ(var aLabels, var aInhalt, var aZusatz, vTitel, 'pcs', vPre, vPost, aKombi);
                    end;
    'PEH' :         begin
                      inc(vZeilen);
    ...
    'VPG' :         begin
                      ...
                      if (Ein.P.AbbindungQ <> 0 or Ein.P.AbbindungL <> 0) then begin
                        //Quer
                        if(Ein.P.AbbindungQ<>0)then vA2 # 'binding '+ AInt(Ein.P.AbbindungQ)+' x over width' ;
                        //Längs
                        if(Ein.P.AbbindungL<>0)then begin
                          if (vA2<>'')then
                            vA2 # vA2+'  '+AInt(Ein.P.AbbindungL)+ ' x over length';
                          else
                            vA2 # 'binding ' + AInt(Ein.P.AbbindungL)+' x over length';
                        end;
                       ADD_VERP(vA2,'')
                       vA2 # '';
                      end;
  ...
  case (StrCnv(vFeld, _StrUpper)) of
    'MENGE+MEH' :   if ("Ein.Z.Menge"<>0.0) then begin
                      ...
                      if (Ein.Z.MEH='Stk') then
                        AddLIZ(var aLabels, var aInhalt, var aZusatz, vTitel, anum("Ein.Z.Menge", 0)+' '+'pcs', vPre, vPost, aKombi)
    ...
    'BEZEICHNUNG'  : begin
                      if("Ein.Z.Schlüssel" = '') then begin
                        ...
                        if (APL_Data:HoleAufpreis("Ein.Z.Schlüssel", today)=_rOK) then begin
                          inc(vZeilen);
                          debugx("APL.L.Bezeichnung.L2");
                          AddLIZ(var aLabels, var aInhalt, var aZusatz, vTitel, APL.L.Bezeichnung.L2, vPre, vPost, aKombi);
                        end;
                      end;
                    end;
    ...
    'MEH' :         begin
                      ...
                      inc(vZeilen);
                      if (Ein.Z.Meh != 'Stk') then AddLIZ(var aLabels, var aInhalt, var aZusatz, vTitel, Ein.Z.MEH, vPre, vPost, aKombi)
                      else AddLIZ(var aLabels, var aInhalt, var aZusatz, vTitel, 'pcs', vPre, vPost, aKombi);
                    end;
    'PEH' :         begin
                      if (Ein.Z.MEH='%') then RETURN 0;
    ...
    'PEH+MEH' :
                    begin
                      ...
                      if (Ein.P.MEH.Preis != 'Stk') then begin
