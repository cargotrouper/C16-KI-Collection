...
//===== Business-Control =================================================
//
//  Prozedur    F_AAA_BAG_Lohn
//                    OHNE E_R_G
//  Info
//    Druckt einen Lohnauftrag aus
//
//
...
begin
  ...
  if (aSeite=1) then begin
    Form_Ele_LohnBAG:elErsteSeite(var elErsteSeite, vStartAS, vZielAS);
    end
  else begin
    Form_Ele_LohnBAG:elFolgeSeite(var elFolgeSeite, vStartAS, vZielAS);
  end;
...
// ------- FUßDATEN --------------------------------------------------------------------------
  ...
  form_Ele_LohnBAG:elEnde1(var elEnde1, vStartAS, vZielAS);
  form_Ele_LohnBAG:elEnde2(var elEnde2, vStartAS, vZielAS);
  form_Ele_LohnBAG:elEnde3(var elEnde3, vStartAS, vZielAS);
