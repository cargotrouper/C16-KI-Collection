...
//  07.11.2014  ST  Auftragsnummer 12 stellig bei Sorierungserstellung für Auftragsnummer
//  18.07.2017  ST  Auf.P.Bemerkung wird in XML ausgegeben
//  13.06.2022  AH  ERX
//
//  Subprozeduren
//    SUB AusSel();
...
begin
  ...
  Sel.Auf.OffeneYN      # true;
  Sel.Auf.ErledigteYN   # true;
  Sel.Auf.RahmenYN      # true;
  Sel.Auf.AbrufYN       # true;
  Sel.Auf.NormalYN      # true;
  Sel.Auf.BerechenbYN   # true;
  "Sel.Auf.!BerechenbYN"  # true;

  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.Mark.Auftrag',here+':AusSel');
...
begin
  ...
  'HEADER' : begin
      ...
      List_Spacing[21]  # List_Spacing[ 20] + 42.0;
      List_Spacing[22]  # List_Spacing[ 21] + 42.0;
      List_Spacing[23]  # List_Spacing[ 22] + 42.0;
      ...
      if (list_xml=true) then begin
        ...
        Lf_Set(19, 'Bemerkung'                        ,n , 0);
        Lf_Set(20, 'Kd. Bestellnr'                        ,n , 0);
        Lf_Set(21, 'Kd. Artikelnr'                        ,n , 0);
    ...
    'AUFTRAG' : begin
      if (aPrint) then begin
        ...
        if (list_xml=true) then begin
          ...
          LF_Set(19, '@Auf.P.Bemerkung'                        ,n , 0);
          LF_Set(20, '@Auf.P.Best.Nummer'                        ,n , 0);
          LF_Set(21, '@Auf.P.KundenArtNr'                        ,n , 0);
...
begin
  ...
  WHILE (RecRead(cFile,vSel,vFlag) <= _rLocked ) DO BEGIN
    ...
    if (aSort=2) then   vSortKey # cnvAI(Auf.P.Nummer,_FmtNumLeadZero,0,12)
