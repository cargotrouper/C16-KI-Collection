...
//===== Business-Control =================================================
//
//  Prozedur    F_STD_MAT_Etikett_FM2
//                      OHNE E_R_G
//  Info
...
// ------ Druck vorbereiten ----------------------------------------------------------------
  ...
  FOR i # 0 LOOP inc(i) WHILE (i < vAnzahl) DO BEGIN
    ...
    if (Lib_Print:FrmJobOpen(y,0,0,n,n,n,'STD_EtikettA5quer') < 0) then begin
      RETURN;
    end;
    ...
    vPrt  # PrtFormOpen(_PrtTypePrintForm,'FRM.STD.Etikett.FM2');
