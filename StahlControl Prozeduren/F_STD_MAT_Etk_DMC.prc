...
//===== Business-Control =================================================
//
//  Prozedur    F_STD_MAT_Etk_DMC
//                      OHNE E_R_G
//  Info
//    Druckt ein Etikett mit DataMatrix
//
//
//  15.09.2014  ST Erstellung der Prozedur
...
// ------ Druck vorbereiten ----------------------------------------------------------------
  ...
  FOR i # 0 LOOP inc(i) WHILE (i < vAnzahl) DO BEGIN
    ...
    vPrt  # PrtFormOpen(_PrtTypePrintForm,'FRM.STD.Etikett.DMC');
