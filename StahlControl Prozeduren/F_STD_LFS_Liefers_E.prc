...
//
//========================================================================
sub Monat_aus_datum_E(aDatum : date): alpha;
begin
  case (aDatum->vpmonth) of
    1 : RETURN Translate('January ');
    2 : RETURN Translate('February');
    3 : RETURN Translate('March');
    4 : RETURN Translate('April');
    5 : RETURN Translate('May');
    6 : RETURN Translate('June');
    7 : RETURN Translate('July');
    8 : RETURN Translate('August');
    9 : RETURN Translate('September');
   10 : RETURN Translate('October');
   11 : RETURN Translate('November');
   12 : RETURN Translate('December');
  end;
end;
...
begin
  ...
  if (aSeite=1) then begin
    ...
    Pls_fontSize # 9;
    PL_Print('Our Customer-No.:',cPosKopf1);
    ...
    Pl_Print('Delivery-note'+' '+AInt(Lfs.Nummer),cPos0 );
    ...
    PL_PrintLine;
    PL_Print('The following positions are included in the delivery:',cPos0);
    PL_PrintLine;
    PL_PrintLine;
...
//      PL_Print('Abmessung' ,cPos3);
    ...
    PL_Print_R('pcs'     ,cPos5);
    PL_Print_R('Grossweight ' + StrAdj(Lfs.P.MEH,_StrBegin),cPos6);
    PL_Print_R('Netweight '  + StrAdj(Lfs.P.MEH,_StrBegin),cPos7);
