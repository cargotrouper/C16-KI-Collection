...
//
//  Info
//  AAR_READ: Lesen von Auftragsarten und Rückgabe der angegeben Felder
//
...
begin
  ...
  vNode->apiSetDesc('Eindeutige Nummer der Auftragsart','700');
...
begin
  ...
  if (RecRead(c_DATEI,1,0) <> _rOK) then begin
      // nicht gefunden
      aResponse->addErrNode(errSVL_Allgemein,'Auftragsart nicht gefunden');
      RETURN errPrevent;
  end;
