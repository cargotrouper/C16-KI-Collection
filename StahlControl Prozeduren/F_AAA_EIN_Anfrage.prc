...
//===== Business-Control =================================================
//
//  Prozedur    F_AAA_EIN_Anfrage
//                  OHNE E_R_G
//  Info
//    Druckt eine Bestellung
//
//
//  18.10.2013  AH  Erstellung der Prozedur
//  04.03.201riert  Abbruch der Druckerausgabe/Vorschau integriert
//  12.05.2022  AH  ERX
//
//  Subprozeduren
...
// ------- POSITIONEN --------------------------------------------------------------------------
  ...
  WHILE (Erx<=_rLocked) do begin
    ...
    else if (Wgr_Data:IstMat(Ein.P.Wgr.Dateinr)) or (Wgr_Data:IstMix(Ein.P.Wgr.Dateinr)) then begin
      RecBufClear(250);
    end
    else
      CYCLE;
