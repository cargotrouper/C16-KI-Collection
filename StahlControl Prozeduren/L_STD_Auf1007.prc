...
//===== Business-Control =================================================
//
//  Prozedur  L_STD_Auf1007
//                    OHNE E_R_G
//  Info
//    Gibt die Auftragsliste aus, nur Angebote
//
//  24.06.2021 SR SQL-Umänderung (Kopie von L_STD_Auf0006)
//
//  Subprozeduren
//
//========================================================================
...
begin
  ...
  Sel.Auf.Vorgangstyp    # 'ANG';   // NUR Angebote
  ...
  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.STD.Auf1007',here+':AusSel');
