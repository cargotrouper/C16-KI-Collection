...
//===== Business-Control =================================================
//
//  Prozedur  L_STD_Adr0001
//                    OHNE E_R_G
//  Info
//
//
//  08.12.2014  AH  Erstellung der Prozedur
...
begin
  ...
  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.STD.ADR0001',here+':AusSel');

  Sel_Main:AddSort(gMdi, 'Kundennr',              'Kundennr', true);
  Sel_Main:AddSort(gMdi, 'Lieferantennr',         'Lieferantennr');
...
//========================================================================
sub AusSel();
//[-] MR 15.03.22 vorherige Implementierung sorgt dafür, dass die Sortierung nur nach dem Stichwort funktioniert.
/*local begin
  vHdl,vHdl2  : int;
  vSort       : alpha;
end;*/
