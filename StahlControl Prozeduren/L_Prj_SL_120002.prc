...
begin
  ...
  case (aName) of
    ...
    Write(12, 'extern h'                                                    ,n , 0);
    Write(13, 'Erledigt'                                                  ,n , 0);
    EndLine();
    ...
    Write(12, ZahlF(Prj.P.Dauer.Extern, 2)                                ,n ,  _LF_Num);
    if ("Prj.P.Lösch.Datum"<>0.0.0) then
       Write(13, DatS("Prj.P.Lösch.Datum") + ' ' + "Prj.P.Lösch.User"     ,n , 0);
    Endline();

    Startline();
    Write(13, "Prj.P.Lösch.Grund"                                         ,n , 0);
    EndLine();
