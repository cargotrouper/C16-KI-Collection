...
//===== Business-Control =================================================
//
//  Prozedur  L_STD_Mat1003
//                    OHNE E_R_G
//  Info
//
//
//  18.05.2021 SR SQL-Umänderung (Kopie von L_STD_MAT0003)
//
//  Subprozeduren
//
//========================================================================
...
begin
  ...
  //x x
  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.Std.Mat1003',here+':AusSel');
  ...
  Sel_Main:AddSort(gMDI, 'Strukturnr. * Abmessung','Strukturnr,Abmessung');
