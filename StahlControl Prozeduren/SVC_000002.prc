...
//
//  Info
///  MTAREAD: Lesen von Materialdaten und Rückgabe der angegeben Felder
//
//  05.01.2011  ST  Erstellung der Prozedur
//  28.01.2011  ST  Refakturing
//  2022-06-29  AH  ERX
//
//  Subprozeduren
//    SUB api() : handle
...
begin
  ...
  vArgs # VarAllocate(Sel_Args_000002);
  ...
  // --------------------------------------------------------------------------
  // Daten selektieren
  vSel  # Lib_SOA:CreatePartSel(200, 1, 'SVC_000002:Sel',vArgs);
  ...
  FOR  Erx # RecRead(200, SOA_PartSel_Sel, _RecFirst);
  LOOP Erx # RecRead(200, SOA_PartSel_Sel, _RecNext);
...
begin
  ...
  VarInstance(Sel_Args_000002, SOA_PartSel_Args);
