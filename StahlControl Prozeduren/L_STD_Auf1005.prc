...
//===== Business-Control =================================================
//
//  Prozedur  L_STD_Auf1005
//                    OHNE E_R_G
//  Info
//    Gibt die Auftragsliste aus
//
//  17.06.2021 SR SQL-Umänderung (Kopie von L_STD_Auf0002)
//
//  Subprozeduren
//
//========================================================================
...
begin
  ...
  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.STD.Auf1005',here+':AusSel');
...
//  AddJsonFloat( vJSON,  'BisZugfestigkeit',  "Sel.Mat.bis.Zugfest");
  AddJsonBool(  vJSON,  'LadeAktionen',   true);
