...
//===== Business-Control =================================================
//
//  Prozedur  L_STD_Art1003
//                    OHNE E_R_G
//  Info
//
//
//  01.06.2021 SR SQL-Umänderung (Kopie von L_STD_Adr1003)
//
//  Subprozeduren
//
//========================================================================
...
begin
  ...
  "Sel.Art.-VerfügbarYN"  # Y;  // EK
  "Sel.Art.+VerfügbarYN"  # Y;  // VK
  Sel.Art.OutOfSollYN     # y;  // Rest

  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.STD.Art1003',here+':AusSel');
...
begin
  ...
  AddJSONBool(vJSON, 'MitEkPreisen', "Sel.Art.-VerfügbarYN");
  AddJSONBool(vJSON, 'MitVkPreisen', "Sel.Art.+VerfügbarYN");
  AddJSONBool(vJSON, 'MitSonstigenPreisen', Sel.Art.OutOfSollYN);
