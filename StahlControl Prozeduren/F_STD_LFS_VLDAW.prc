...
//===== Business-Control =================================================
//
//  Prozedur    F_STD_LFS_VLDAW
//                      OHNE E_R_G
//  Info
//    Druckt eine Verladeanweisung aus
//
//
//  07.06.2011  AI  Erstellung der Prozedur
...
begin
  ...
  if (aSeite=1) then begin
    ...
    Pl_Print('Verladeanweisung '+AInt(Lfs.Nummer),cPos0 );
    pl_PrintLine;
    pl_PrintLine;
    pls_Fontattr # _WinFontAttrNormal;
    PL_Print('Bitte bereiten Sie folgende Materialien zur Verladung vor:',cPos0);
    pl_PrintLine;
    ...
    Pls_FontSize # 10;
    pls_Fontattr # _WinFontAttrBold;
    Pl_Print('VSB-Meldung '+AInt(Lfs.Nummer),cPos0 );
    pl_PrintLine;
