...
//
//  Info
//  BAG_READ: Lesen von Betrriebsauftragskopfdaten und Rückgabe der angegeben Felder
//
...
begin
  ...
  vNode->apiSetDesc('Eindeutige Nummer des Betriebsauftrages','314341');
...
begin
  ...
  if (RecRead(c_DATEI,1,0) <> _rOK) then begin
      // nicht gefunden
      aResponse->addErrNode(errSVL_Allgemein,'Betriebsauftrag nicht gefunden');
      RETURN errPrevent;
  end;
