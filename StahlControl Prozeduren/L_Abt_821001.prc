...
//==== Business-Control ===================================================
//
//  Prozedur    L_Abt_821001
//                    OHNE E_R_G
//  Info
//        Liste: Schlüsseldaten Abteilungen
//
...
begin
  case aName of
    ...
    'line' : begin
      ...
      LF_Set( 1, '@Abt.Nummer',      y, _LF_IntNG );
      LF_Set( 2, '@Abt.Bezeichnung', n, 0 );
    end;
  end;
end;
...
begin
  ...
  vPrgr # Lib_Progress:Init( 'Listengenerierung', RecInfo( 821, _recCount ) );
