...
//===== Business-Control =================================================
//
//  Prozedur  L_STD_Mat1001
//                    OHNE E_R_G
//  Info
//
//
//  04.05.2021 SR SQL-Umänderung (Kopie von L_STD_Mat0001)
//
//  Subprozeduren
//
//========================================================================
...
begin
  ...
  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.Std.Mat1001',here+':AusSel');
