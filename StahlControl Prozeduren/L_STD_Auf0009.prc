...
//===== Business-Control =================================================
//
//  Prozedur  L_STD_Auf0009
//                    OHNE E_R_G
//  Info
//    Gibt die Auftragsliste aus
//
//  2023-03-15  SR  Erstellung der Prozedur
//
//  Subprozeduren
//
//========================================================================
...
begin
  ...
  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.STD.Auf0009',here+':AusSel');
...
begin
  ...
  AddJsonBool( vJSON,  'MitAuftraegen', "Sel.Mat.EigenYN");
  AddJsonBool( vJSON,  'MitAngeboten', "Sel.Mat.BestelltYN");
  // ---------------------------------------------------------
...
//  AddJsonInt(   vJSON,  'BisOberflaeche',   "Sel.Auf.ObfNr2");
  ...
  AddJsonFloat( vJSON,  'VonRID',        "Sel.Mat.von.Breite");
  AddJsonFloat( vJSON,  'BisRID',        "Sel.Mat.bis.Breite");
  AddJsonFloat( vJSON,  'VonRAD',        "Sel.Mat.von.Länge");
  AddJsonFloat( vJSON,  'BisRAD',        "Sel.Mat.bis.Länge");
  // ----------------------------------------------------------
