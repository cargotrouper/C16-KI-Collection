...
//  31.07.2008  DS  QUERY
//  21.06.2010  TM  Kopie aus 400.001 und Anpassung an Auftragsablage
//  13.06.2022  AH  ERX
//
//  Subprozeduren
//    SUB AusSel();
...
begin
  ...
  Sel.Auf.bis.WTermin   # 1.1.2010;
  Sel.Auf.bis.AufArt    # 999;
  Sel.Auf.bis.WGr       # 9999;
  Sel.Auf.bis.DruckDat  # 1.1.2010;
  Sel.Auf.bis.LiefDat   # 1.1.2010;
  Sel.Auf.bis.ZTermin   # 1.1.2010;
...
begin
  ...
  List_Spacing[ 6]  # List_Spacing[ 5] + 13.0;
  ...
  List_Spacing[15]  # List_Spacing[ 14] + 18.0; // 20
...
//Rest?      vMenge  # Lib_Einheiten:WandleMEH(401, Auf.P.Prd.Rest.Stk, Auf.P.Prd.Rest.Gew, Auf.P.Prd.Rest, Auf.P.MEH.Wunsch, Auf.P.MEH.Preis);
      ...
      if (list_xml=true) then begin
        ...
        */
        ...
        Write(14, cnvad("Auf~P.Termin1Wunsch")                        ,y , 0,2.0);
      end;
...
begin
  ...
  if (vKey=0) then begin
    ...
    vSel->SelAddLink('', 412, 411, 11, 'Ausf');
