...
//==== Business-Control ===================================================
//
//  Prozedur    L_IHA_824001
//                    OHNE E_R_G
//  Info
//        Liste: Schlüsseldaten Instandhaltung/Ursachen
//
...
begin
  case aName of
    ...
    'line' : begin
      ...
      LF_Set( 1, '@IHA.Urs.Nummer',      y, _LF_IntNG );
...
begin
  ...
  FOR   Erx # RecRead( 824, 1, _recFirst );
  LOOP  Erx # RecRead( 824, 1, _recNext );
