...
//==== Business-Control ==================================================
//
//  Prozedur    SVC_BAG_P_0005
//                  OHNE E_R_G
//  Zu Service: BAG_P_VSB_CLEAR
//
//  Info
//  Löscht VSB Einträge für den angegeben Arbeitsgang, oder alle
//
//  http://192.168.0.2:5060/?sender=A1386&service=bag_p_vsb_clear&bag.p.nummer=1336&bag.p.position=2
//
//  10.03.2015  ST  Erstellung der Prozedur
//  2022-06-29  AH  ERX
//
//  Subprozeduren
//    SUB api() : handle
...
begin
  ...
  vNode->apiSetDesc('Positionsnr des Arbeitsgangs, 0 für alle','1');
...
begin
  ...
  Erx # BA1_P_Data_SOA:AutoVsb(Bag.P.Nummer, Bag.P.Position);
...
begin
  ...
  vArgs->Lib_XML:AppendNode(toUpper('service'),'BAG_P_VSB_CLEAR');
