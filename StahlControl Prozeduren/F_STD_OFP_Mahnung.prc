...
begin
  ...
  if (aSeite=1) then begin
    ...
    Pl_Print('Mahnung' ,cPos0);
    PL_Print(cnvAD(today, _FmtInternal), cPosH1);
    PL_Print_R('Seite: '+cnvAI(aSeite,_FmtInternal), 188.0);
    PL_PrintLine;
    Pls_FontSize # 9;
    pls_Fontattr # 0;
    PL_PrintLine;
    ...
    PL_PrintLine;
    PL_Print('Ihre Kundennr.', cPosXH0);
    PL_Print(':', cPosXH1);
    PL_PrintI_L(Adr.Kundennr, cPosXH2);
    PL_Print('Unsere Zeichen', cPosXH3);
    PL_Print(':', cPosXH4);
    PL_Print(Usr.Anrede + ' ' + Usr.Name, cPosXH5);
    PL_PrintLine;
    PL_Print('Ihre Ust-IdNr.', cPosXH0);
    PL_Print(':', cPosXH1);
  ...
  if (form_mode <> 'FUSS') then begin
    pls_FontSize  # 8;
    PL_Print_R('Re.-Nr.'                              , cPosC0);
    PL_Print('Re.-Datum'                              , cPosC1);
    PL_Print('Fälligkeit'                             , cPosC2);
    PL_Print_R('Stufe'                                  , cPosC3);
    PL_Print('Nachfrist'                              , cPosC4);
    PL_Print_R('Re.Betrag'                            , cPosC5);
    PL_Print_R('Gebühren'                             , cPosC6);
    PL_Print_R('Zinsen'                               , cPosC7);
    PL_Print_R('offener  Betrag '                     , cPosC8);
    PL_PrintLine;
