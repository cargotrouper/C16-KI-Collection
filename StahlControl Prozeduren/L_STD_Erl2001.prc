...
//===== Business-Control =================================================
//
//  Prozedur  L_STD_Erl1001
//                    OHNE E_R_G
//  Info
//
//
//  07.09.2021 SR SQL-Umänderung (Kopie von L_STD_Erl0001)
//
//  Subprozeduren
//
//========================================================================
...
begin
  ...
  gMDI # Lib_GuiCom:AddChildWindow(gMDI,'Sel.STD.Erl1001',here+':AusSel');
...
begin
  ...
  // ----------------------------------------------------------
  AddJSONAlpha(vJSON,'ConnectionString', Lib_SQL:ConnectionString()); //++
