...
//===== Business-Control =================================================
//
//  Prozedur    F_STD_MAT_Etk_Ring
//                          OHNE E_R_G
//  Info
//    Druckt ein Ringetikett
//
//
//  24.01.2012  ST Erstellung der Prozedur
...
// ------ Druck vorbereiten ----------------------------------------------------------------
  ...
  FOR i # 0 LOOP inc(i) WHILE (i < vAnzahl) DO BEGIN
    ...
    if (Lib_Print:FrmJobOpen(y,0,0,n,n,n,'STD_Etikett103x48', 'FALSE') < 0) then begin
      RETURN;
    end;
    ...
    vPrt  # PrtFormOpen(_PrtTypePrintForm,'FRM.Etikett.Ring');
