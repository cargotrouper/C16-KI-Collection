...
//==== Business-Control ===================================================
//
//  Prozedur    L_Mat_820001
//                    OHNE E_R_G
//  Info
//        Liste: Schlüsseldaten Materialstatus
//
...
begin
  case aName of
    ...
    'line' : begin
      ...
      LF_Set( 1, '@Mat.Sta.Nummer',      y, _LF_IntNG );
      LF_Set( 2, '@Mat.Sta.neueNummer',  y, _LF_IntNG );
      LF_Set( 3, '@Mat.Sta.Bezeichnung', n, 0 );
    end;
  end;
end;
