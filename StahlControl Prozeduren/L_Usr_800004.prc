...
begin
  ...
  FOR   Erx # RecLink(924,922,1,_RecFirst)
  LOOP  Erx # RecLink(924,922,1,_RecNext)
  WHILE Erx = _rOK DO BEGIN
...
begin
  ...
  FOR   Erx # RecLink(v911 ,v910,1,_RecFirst)
  LOOP  Erx # RecLink(v911 ,v910,1,_RecNext)
  WHILE Erx = _rOK DO BEGIN
...
begin
  ...
  FOR   Erx # RecRead(801,1,_RecFirst)
  LOOP  Erx # RecRead(801,1,_RecNext)
  WHILE Erx = _rOK DO BEGIN
    vProgress->Lib_Progress:Step();
  ...
  FOR   Erx # RecRead(v910,1,_RecFirst);
  LOOP  Erx # RecRead(v910,1,_RecNext);
  WHILE Erx = _rOK DO BEGIN
    vProgress->Lib_Progress:Step();
